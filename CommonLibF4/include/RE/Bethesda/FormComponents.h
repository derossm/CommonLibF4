...
namespace RE
{
	...
	public:
		...
		virtual void          CopyComponent([[maybe_unused]] BaseFormComponent* a_copy, [[maybe_unused]] TESForm* a_owner) { return; }  // 05 // TODO are these actually out of order, or the numbers wrong?
	};
